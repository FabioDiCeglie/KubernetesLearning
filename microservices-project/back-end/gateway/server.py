...
mongo_video = PyMongo(server, uri=os.getenv("MONGO_URI") or "mongodb://host.minikube.internal:27017/videos")
mongo_mp3 = PyMongo(server, uri=os.getenv("MONGO_URI") or "mongodb://host.minikube.internal:27017/mp3s")
